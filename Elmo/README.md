...
4. Assure that you are using a python version between 3.8 and 3.11

5. Download the 3 scripts available into the same folder:
...
### Run the [sample code](elmo_test.py)
```
